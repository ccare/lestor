...
public class KratiEntityDatabaseTest extends EntityDatabaseTestBase{
	...
	public void tearDown(){
		System.clearProperty(KratiEntityDatabase.DB_LOCATION_PROPERTY);
	}
	
	@Override
	public EntityDatabase getDatabase() {
		return new KratiEntityDatabase(new POSerializer(), id);
	}
	
	@Test
	public void getGraph() throws Exception{
		KratiEntityDatabase db = new KratiEntityDatabase(new POSerializer(), id);
