...
public class LevelDbEntityDatabase2Test extends EntityDatabaseTestBase{
	...
	public EntityDatabase getDatabase() {
		return new LevelDbEntityDatabase2(new POSerializer(), id);
	}
	
	@Test
	public void getGraph() throws Exception{
		LevelDbEntityDatabase2 db = new LevelDbEntityDatabase2(new POSerializer(), id);
